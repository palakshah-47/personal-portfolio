...
export const projects: Project[] = [
	{
		title: 'DomusAI',
		description:
			'Enterprise AI agent platform built end-to-end at Alter Domus — React 19 + TypeScript integrating Anthropic Claude via a secured LLM gateway with identity-platform authentication, backend-persisted sessions and message history, real-time token streaming, and a no-code Agent Builder with configurable model parameters, tools, actions, and MCPs.',
		tags: ['React 19', 'TypeScript', 'Anthropic Claude', 'LLM Gateway', 'Streaming', 'MCP'],
